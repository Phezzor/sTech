...
const AddTransactionPage = ({ userData }) => {
  ...
  useEffect(() => {
    if (!isAdmin) {
      showAnimatedError("Access denied. Only administrators can add transactions.");
      navigate("/transaksi");
      return;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    showAnimatedInfo("Creating transaction...");
    ...
    try {
      ...
      showAnimatedSuccess(`🎉 Transaction created successfully!`);
      ...
      showAnimatedError(`❌ ${error.message || "Failed to create transaction. Please try again."}`);
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6 border border-blue-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-600 mt-2">Create a new transaction with multiple items</p>
            </div>
            <button
